document.addEventListener('DOMContentLoaded', function() {
    ...
    statusSelect.addEventListener('change', function() {
        ...
        // Negative / Unknown Handling Routing Setup
    ...
    remarksForm.addEventListener('submit', function(e) {
        ...
        // RESIDENCE - UNKNOWN (Updated Template Match)
            ...
            remarksText = `THE GIVEN ADDRESS IS LOCATED BUT ACCORDING TO NEIGHBORS, ${role} IS UNKNOWN RESIDING AT THE GIVEN ADDRESS. FCV WENT TO NEARBY HOUSES BUT STILL ${role} REMAINED UNKNOWN AND UNFAMILIAR. UPON BRGY CHECKING, ${role} IS ${voter} AND ${resident} BASED ON RECORDS. NO OTHER INFORMATION WAS GATHERED. ALL/OTHER INFORMANTS REFUSED TO TAKE SELFIE WITH FCV.`;
        }
        // EMPLOYMENT - LOCATED
    ...
    function hideAllFormSections() {
        const sections = [
            'residenceFormSection', 'residenceUnknownSection',
